@echo off
color 0B
title Update Aplikasi RME RS HARAPAN PEMATANGSIANTAR
cls

set file_url=http://192.168.0.1:8181/app/images/files/RME_VITA.zip
set download_path=D:\HIS\RME_HARAPAN-master.zip
set temp_extract=D:\HIS\update_temp
set app_folder=D:\HIS\RME HARAPAN
set app_name=harapan_app.exe
set app_path="D:\HIS\RME HARAPAN\harapan_app.exe"

echo =========================================
echo        PEMBARUAN APLIKASI RME HARAPAN
echo =========================================
echo.
...
xcopy "%temp_extract%\RME_HARAPAN-master\*" "%app_folder%\" /E /Y /Q
